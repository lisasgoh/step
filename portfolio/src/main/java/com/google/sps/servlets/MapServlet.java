...
/** Returns Bigfoot data as a JSON array, e.g. [{"lat": 38.4404675, "lng": -122.7144313}] */
...
public class MapServlet extends HttpServlet {
  ...
  public void init() {
    ...
    Scanner scanner = new Scanner(getServletContext().getResourceAsStream("/WEB-INF/bigfoot-data.csv"));
